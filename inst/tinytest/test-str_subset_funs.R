...
# "substr_extract with stringfish works", {
...
# "substr_repl with stringfish works", {
...
# "substr_chartr with stringfish works", {
...
# "substr_addin with stringfish works", {
...
# "substr_arrange with stringfish works", {
