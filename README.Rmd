...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 17 April 2023: Small textual changes to the documentation and Read-Me file.
...
The `tidyoperators` R package adds the following functionality:
 ...
 - Infix logical operators for exclusive-or, not-and, not-in, `grepl`, number-type, and string-type.
