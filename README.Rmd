...
Loading a package alias does have some drawbacks. One is that you cannot easily import multiple packages under the same alias. There are a couple of situations where importing multiple packages into a single alias might be preferable:
