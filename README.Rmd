...
is very cumbersome. The `%m import <-%` will therefore also notify the user when attempting to import an R-package where more than half of the functions are operators.
