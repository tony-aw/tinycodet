...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 29 September: Minor textual corrections in documentation and website. Removed `%ss%`. Added badges to pattern arguments of the stringi-based functions. Added a package startup message.
