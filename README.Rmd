...
Loading a package alias does have some drawbacks. One is that you cannot easily import multiple packages under the same alias. While one would probably not want to import **multiple** packages under a single alias most of the time, there are actually a couple of situations where importing multiple packages into a single alias might be actually preferable:
