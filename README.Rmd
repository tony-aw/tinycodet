...
The 'tinycodet' R-package adds a few functions to help in your coding etiquette. It primarily focuses on 4 things:
...
The 'tinycodet' R-package has only one dependency, namely 'stringi'. Most functions in this R-package are vectorised and optimised.
