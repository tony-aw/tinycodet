...
The `tinyoperators` R-package adds some much needed infix operators, and a few functions. It primarily focuses on 4 things:
...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 21 June 2023: Migrated the tests from `testthat` to `tinytest`. Added tests for the new `%:=%` operator. Adjusted the documentation, and this Read-Me file.
