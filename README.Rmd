...
The `import_as()` function will first load the dependencies in the order specified in argument `deps` (so the order matters), if any. Then it loads the package named in argument `package`. And then it loads the extensions in the order specified in argument `extensions` (again, the order matters), if any.
