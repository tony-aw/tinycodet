...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 29 September: Minor textual corrections in documentation and website. Added badges to pattern arguments of the stringi-based functions. Added a package startup message. Removed `%ss%`. Added missing boundaries functions, and made the existing boundaries functions more conform to `stringi`.
