...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 18 September 2023: LAST MAJOR UPDATE (I promise): changed the (yet again) to `tinycodet`. R package is now basically finished, safer for some teeny tiny textual edits in the documentation here and there.
