...
# CHANGELOG (pre-release):
 ...
 - 7 October: changed the name of the pattern list specification functions to starts with s_ rather than stri_, to clarify they're only for infix operators.
