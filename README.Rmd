...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 22 April 2023: Added the `boundaries` argument to the `stri_locate_ith()` function. Added more tests for `stri_locate_ith()`.
