...
the main arguments of the `import_as()` function are:
 ...
 - `depends`: a character vector giving the dependencies of the main package to load under the alias also. One can also set this to `TRUE`, in which case ALL dependencies of the main package are loaded.
