...
One can find your active script's location in base R without external R packages ("external" meaning not base packages, not recommended R packages that come pre-installed with R, and not R packages that are bundled with Rstudio) like `this.path` or `here`.
