...
CHANGELOG (EXPERIMENTAL VERSIONS):
 ...
 - 16 August 2023: special attributes from alias objects can now be more neatly retrieved using the `attr.import()` function. The `args` special attribute from alias objects now also reports the `lib.loc` argument. Slightly re-organized the special attributes contained in alias objects.
