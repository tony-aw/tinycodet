...
'tinycodet' is a small R-package that adds a few functions to help in your coding etiquette. It primarily focuses on 4 things:
...
'tinycodet' adheres to the [tinyverse](https://www.tinyverse.org/) philosophy (not to be confused with the tidyverse). It has only one dependency, namely 'stringi'. No other dependencies, thus avoiding "dependency hell". Most functions in this R-package are vectorized and optimised.
