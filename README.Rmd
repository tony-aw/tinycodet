...
I believe `tidyoperators` is close to becoming stable. There does not appear a need to add more functions/operators, although some operators may need to be tweaked a bit. Although tests have already been performed on the functions and operators in this package, more extensive tests will soon be created. Once I am fully satisfied with the R package (which may take a while, as I am a bit of a perfectionist), I may attempt to publish this R package to CRAN.
