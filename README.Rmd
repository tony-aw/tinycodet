...
For the sake of proper programming etiquette, 
I also highly recommend the `this.path` R package (https://github.com/ArcadeAntics/this.path), which allows for getting the path of the current script (i.e. get the source file location), without all the issues found in packages such as the `here` and `whereami` packages.
