...
## CHANGELOG (pre-release):
 ...
 - 5 October 2023: Reduced the amount of text in the arguments sections. Reduced the number of suggested packages. Added URLs to the GitHub page and Website.
 - 7 October 2023: changed the name of the pattern list specification functions to starts with s_ rather than stri_, to clarify they're only for infix operators.
