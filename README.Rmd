...
The `tidyoperators` R package adds the following functionality:
 ...
 - Several in-place modifying arithmetic and string operators, and a few functions, to help reduce repetitive codes, for the sake of the "Don't Repeat Yourself"-coding principle.
