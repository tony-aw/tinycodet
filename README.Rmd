...
Here a conditional subset of the object `x` is transformed with function `f`, where the condition is using a function referring to `x` itself (namely `x>0`). Consequently, reference to `x` is written **four times**!
