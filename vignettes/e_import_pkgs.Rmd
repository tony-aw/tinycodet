...
Loading a package alias does have some drawbacks. One is that you cannot easily import multiple related packages under the same alias. Althoygh one may not always want to import **multiple** related packages under a **single alias**, there are several situations where importing multiple packages into a single alias may be preferable:
