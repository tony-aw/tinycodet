...
Of course, if one wishes to use 'stringi' only within a specific environment, like only inside a function, it becomes advantageous to load 'stringi' using the 'tinycodet' import system - in that case the `import_LL()` function would be most applicable.
