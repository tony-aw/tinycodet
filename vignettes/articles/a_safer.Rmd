...
Another example: `1:10 == c(4, 6)` is silently transformed to `1:10 == rep(c(4, 6), each = 5)`, and thus gives `c(rep(FALSE, 5), TRUE, rep(FALSE, 4))`; this may not be what the user wants. But `1:10 %d==% c(4, 6)` prevents this by returning an error instead.
