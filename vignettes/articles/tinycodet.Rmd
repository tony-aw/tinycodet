...
In base R, `(0.1*3) == 0.3` gives `FALSE`, due to the way decimal numbers are stored in computers.  `tinycodet` adds safer truth testing operators, that give correct results.
