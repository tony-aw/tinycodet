...
* **Argument change:** There are now also the explicit `stri_locate_ith_[regex/fixed/coll/charclass]` functions, using the same argument conventions as the rest of 'stringi'.
