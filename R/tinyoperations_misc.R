#' The tinyoperations miscellaneous functionality
#'
#'@description
#'
...
#'  * \link[=stricter_TrueFalse]{restrict re-assignment of "T" and "F"}.
...
#' @rdname tinyoperations_misc
#' @export
tinyoperations_misc <- function() {
  utils::`?`(tinyoperations_misc)
}
