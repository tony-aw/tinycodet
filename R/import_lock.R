...
#' delete locked objects created by \code{import_inops()} or \code{import_as()} when it needs to overwrite them.
#' Any user-defined objects are not touched in this process.
