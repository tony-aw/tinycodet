...
#' @param cond a (possibly anonymous) function that returns a binary logic (\code{TRUE,FALSE}) vector
#' of the same length/dimensions as \code{x}. \cr
#' For example: \code{is.na}.
#' @param trans_T the (possibly anonymous) transformation function to use when \code{cond(x)==TRUE}. \cr
#' For example: \code{log}. \cr
#' If this is not specified, \code{trans_T} defaults to \code{function(x)x}.
#' @param trans_F the (possibly anonymous) transformation function to use when \code{cond(x)==FALSE}. \cr
#' For example: \code{log}. \cr
