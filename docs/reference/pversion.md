...
#> 32        vctrs          0.7.3           0.7.3           TRUE
#> 33           R6          2.6.1           2.6.1           TRUE
#> 34    lifecycle          1.0.5           1.0.5           TRUE
#> 35           fs          2.1.0           2.1.0           TRUE
#> 36  htmlwidgets          1.6.4           1.6.4           TRUE
#> 37         ragg          1.5.2           1.5.2           TRUE
#> 38  fontawesome          0.5.3           0.5.3           TRUE
#> 39    pkgconfig          2.0.3           2.0.3           TRUE
#> 40         desc          1.4.3           1.4.3           TRUE
#> 41    tinycodet          0.7.1           0.7.1           TRUE
#> 42       gtable          0.3.6           0.3.6           TRUE
#> 43      pkgdown          2.2.1           2.2.1           TRUE
#> 44       pillar         1.11.1          1.11.1           TRUE
#> 45        bslib          0.9.0           0.9.0           TRUE
#> 46         glue          1.8.0           1.8.0           TRUE
#> 47   data.table         1.18.4          1.18.4           TRUE
#> 48         Rcpp          1.1.2           1.1.2           TRUE
#> 49  systemfonts          1.3.2           1.3.2           TRUE
#> 50     collapse          2.1.7           2.1.7           TRUE
